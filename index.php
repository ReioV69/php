...
<head>
    <meta charset="utf-8">
    <title>Electro - Kodumasinate pood </title>
    ...
    <div class="container-fluid px-5 d-none border-bottom d-lg-block">
        <div class="row gx-0 align-items-center">
            ...
            <div class="col-lg-4 text-center d-flex align-items-center justify-content-center">
                ...
                <a href="#" class="text-muted">58594398</a>
            </div>
                        ...
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0">
                                    ...
                                    <a href="cart.html" class="dropdown-item">Ostukorv</a>
...
<div class="container-fluid carousel bg-light px-0">
            ...
            <div class="col-12 col-lg-7 col-xl-9">
                <div class="header-carousel owl-carousel bg-light py-5">
                    <div class="row g-0 header-carousel-item align-items-center">
                        ...
                        <img src="<?php echo $randomImage; ?>" class="img-fluid w-100" alt="Random Image">
                        </div>
                        ...
                        <div class="col-xl-6 carousel-content p-4">
                            ...
                            <h1 class="display-3 text-capitalize mb-4 wow fadeInRight" data-wow-delay="0.3s">On Selected
                                Dishwashers & Microwaves Or Fridge</h1>
                    ...
                    <div class="row g-0 header-carousel-item align-items-center">
                        <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                            <img src="<?php echo $randomImages; ?>" class="img-fluid w-100" alt="Image">
                        </div>
                        <div class="col-xl-6 carousel-content p-4">
                            <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight" data-wow-delay="0.1s"
            ...
            <div class="row g-4">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        <div>
                            <p class="text-muted mb-3">Leia parim tolmuimeja endale!</p>
                            <h3 class="text-primary">Võimas imeja</h3>
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        <div>
                            <p class="text-muted mb-3">Leia parim kingitus naisele!</p>
                            <h3 class="text-primary">Pesumasin</h3>
                            <h1 class="display-3 text-secondary mb-0">20% <span
                                    class="text-primary fw-normal">Off</span></h1>
                        </div>
                        <img src="img/product-3.png" class="img-fluid" alt="">
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        ...
                                        <div class="text-center rounded-bottom p-4">
                                            <a href="#" class="d-block mb-2"><?= $nimi ?></a>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-7">
                                <div class="products-mini-content p-3">
                                    <a href="#" class="d-block mb-2">Toidu kuivati</a>
                                    <a href="#" class="d-block h4">Apple iPad Mini <br> G2356</a>
                                    <del class="me-2 fs-5">$1,250.00</del>
                                    <span class="text-primary fs-5">$1,050.00</span>
                                </div>
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            ...
                            <div class="col-7">
                                <div class="products-mini-content p-3">
                                    <a href="#" class="d-block mb-2">Smart</a>
                                    <a href="#" class="d-block h4">Apple iPad Mini <br> G2356</a>
                                    <del class="me-2 fs-5">$1,250.00</del>
                                    <span class="text-primary fs-5">$1,050.00</span>
                                </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            ...
                            <div class="col-7">
                                <div class="products-mini-content p-3">
                                    <a href="#" class="d-block mb-2">Kuivati</a>
                                    <a href="#" class="d-block h4">Apple iPad Mini <br> G2356</a>
                                    <del class="me-2 fs-5">$1,250.00</del>
                                    <span class="text-primary fs-5">$1,050.00</span>
                                </div>
    ...
    <div class="container-fluid products pb-5">
        <div class="container products-mini py-5">
            ...
            <div class="row g-4">
                <div class="col-md-3 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="products-mini-item border">
                        <div class="row g-0">
                            ...
                            <div class="col-7">
                                <div class="products-mini-content p-3">
                                    <a href="#" class="d-block mb-2">Tolmuimeja</a>
                                    <a href="#" class="d-block h4">Tolmuimeja <br> G2356</a>
                                    <del class="me-2 fs-5">$1,250.00</del>
                                    <span class="text-primary fs-5">$1,050.00</span>
                                </div>
                            </div>
                ...
                <div class="col-md-3 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                ...
                <div class="col-md-3 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
    ...
    <!-- Footer Start -->
    <div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s" style="background: rgba(20, 165, 184, 0.98);">
        <div class="container py-5">
            <div class="row g-4 rounded mb-5" style="background: rgba(63, 66, 231, 0.95);">
                <div class="col-md-3 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            ...
                            <p class="mb-2">Wismari tn 15, 10136 Tallinn</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            ...
                            <p class="mb-2">reio@hkhk.edu.ee</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-lg-6 col-xl-3">
                ...
                <div class="col-md-3 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            <h4 class="text-white">reio@hkhk.edu.ee</h4>
                            <p class="mb-2"> 58594398</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-md-3 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        <div class="footer-item" style="background: rgba(16, 13, 163, 0.856);">
                ...
                <div class="col-md-3 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column" style="background: rgba(16, 13, 163, 0.856);">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d87164.95896171182!2d24.64907320021572!3d59.432103700000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4692949ca7dfeddb%3A0x24fb8d9ad53a95e8!2sWismari%20Haigla!5e1!3m2!1set!2see!4v1759217721163!5m2!1set!2see" height="400" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
</div>
                    </div>
    ...
    <div class="container-fluid copyright py-4">
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-md-3 text-center text-md-start mb-md-0">
                    <span class="text-white"><a href="#" class="border-bottom text-white"><i
                                class="fas fa-copyright text-light me-2"></i>Your Site Name</a>, All right
                        reserved.</span>
                </div>
                <div class="col-md-3 text-center text-md-end text-white">
